...
static const struct pmux_pingrp_config jetson_tk1_pingrps[] = {
	...
	PINCFG(UART2_CTS_N_PJ5,        UARTA,        UP,     TRISTATE, INPUT,   DEFAULT, DEFAULT),
	PINCFG(UART2_RTS_N_PJ6,        UARTA,        NORMAL, NORMAL,   OUTPUT,  DEFAULT, DEFAULT),
	...
	PINCFG(UART3_TXD_PW6,          GMI,          NORMAL, NORMAL,   INPUT,   DEFAULT, DEFAULT),
	...
	PINCFG(PBB0,                   VIMCLK2,      NORMAL, NORMAL,   OUTPUT,  DEFAULT, DEFAULT),
	...
	PINCFG(CAM_MCLK_PCC0,          VI_ALT1,      NORMAL, NORMAL,   OUTPUT,  DEFAULT, DEFAULT),
	...
	PINCFG(USB_VBUS_EN2_PFF1,      USB,          NORMAL, NORMAL,   INPUT,   DISABLE, DEFAULT),
